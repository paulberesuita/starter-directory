// Tailwind color resolver utility
// This maps Tailwind color class names to their actual CSS values
// Updated to match the official Tailwind CSS v4.x OKLCH colors (exact values)
// Source: Official Tailwind CSS v4 @theme definition (January 2025)

const tailwindColors = {
  // Red palette - official OKLCH values
  ...
  // Orange palette - official OKLCH values
  ...
  // Amber palette - official OKLCH values
  ...
  // Yellow palette - official OKLCH values
  ...
  // Lime palette - official OKLCH values
  ...
  // Green palette - official OKLCH values
  ...
  // Emerald palette - official OKLCH values
  ...
  // Teal palette - official OKLCH values
  ...
  // Cyan palette - official OKLCH values
  ...
  // Sky palette - official OKLCH values
  ...
  // Blue palette - official OKLCH values
  ...
  // Indigo palette - official OKLCH values
  ...
  // Violet palette - official OKLCH values
  ...
  // Purple palette - official OKLCH values
  ...
  // Fuchsia palette - official OKLCH values
  ...
  // Pink palette - official OKLCH values
  ...
  // Rose palette - official OKLCH values
  ...
  // Slate palette - official OKLCH values
  ...
  // Gray palette - official OKLCH values
  ...
  // Zinc palette - official OKLCH values
  ...
  // Neutral palette - official OKLCH values
  ...
  // Stone palette - official OKLCH values
...
/**
 * Resolves a Tailwind color class name to its actual CSS color value
 * @param colorName - The Tailwind color class name (e.g., 'blue-500', 'gray-100')
 * @returns The CSS color value (OKLCH format or special color)
 */
export function resolveTailwindColor(colorName: string): string {
  const color = tailwindColors[colorName as keyof typeof tailwindColors];
  
  if (!color) {
    console.warn(`Unknown Tailwind color: ${colorName}. Using transparent as fallback.`);
    return 'transparent';
  }
